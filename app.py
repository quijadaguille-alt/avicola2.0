...
<style>
    ...
    /* 🔴 BOTÓN ROJO - Ver Inventario */
    .st-key-btn_ver_inv button {
        background-color: #be123c !important; color: #ffffff !important; border: none !important;
        text-align: center !important; justify-content: center !important;
        box-shadow: none !important;
    }
    .st-key-btn_ver_inv button:hover { background-color: #9f1239 !important; border: none !important; }
    .st-key-btn_ver_inv button * { color: #ffffff !important; }

    /* 🟢 BOTONES VERDES - Guardar */
    .st-key-btn_save_bajas button,
    .st-key-btn_save_inventario button {
    ...
    .st-key-btn_save_bajas button:hover,
    .st-key-btn_save_inventario button:hover { background-color: #059669 !important; border: none !important; }
    .st-key-btn_save_bajas button *,
    .st-key-btn_save_inventario button * { color: #ffffff !important; }

    /* Botón Volver */
    .st-key-back_m button, .st-key-back_i button {
    ...
    .st-key-back_m button *, .st-key-back_i button * { color: #475569 !important; }
</style>
    ...
    with st.container():
        ...
        if st.session_state.sobreescribir_muertes and st.session_state.temp_muertes:
            ...
            if t_m["fecha"] == fecha_str:
                ...
                if st.button("⚠️ Sí, sobrescribir datos", use_container_width=True, key="btn_ow_bajas"):
                    supabase_client, _ = get_supabase_client()
                    supabase_client.table("registro_bajas").delete().eq("fecha", fecha_str).execute()
    ...
    with st.container():
        ...
        if st.session_state.sobreescribir_inventario and st.session_state.temp_inventario:
            ...
            if t_i["fecha"] == fecha_str:
                ...
                if st.button("⚠️ Sí, deseo sobrescribir el inventario", use_container_width=True, key="btn_ow_inv"):
                    supabase_client, _ = get_supabase_client()
                    try:
